...
function SideBarItemTemplateWithData({
	...
	const roomUrgency = room.urgency == 'urgent' ? 'rs-urgency-urgent' : (room.urgency == 'moderate' ? 'rs-urgency-moderate' : '')
	return (
		<SideBarItemTemplate
			is='a'
			id={id}
...
const propsAreEqual = (prevProps, nextProps) => {
	...
	if (prevProps.room.urgency !== nextProps.room.urgency) {
		return false;
	}
